...
export const users = pgTable("users", {
  ...
  balance: decimal("balance", { precision: 20, scale: 8 }).default("0").notNull(), // In USD
  energyBalance: decimal("energy_balance", { precision: 20, scale: 8 }).default("0").notNull(), // In kWh
